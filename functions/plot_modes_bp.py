...
if __name__ == "__main__":
    ...
    # working_dir = (r"C:/Users/florian.regnault/Documents/data/L2/ITHACAoutput/Reduced_coeff_16_0"+
    #                r".0005_100_reducedOrderPressure_0_centered_Stra")
    working_dir = (r"C:/Users/florian.regnault/Documents/data/L2/ITHACAoutput/Reduced_coeff_16_0"+
                   r".0005_100_fullOrderPressure_centered_Stra")

    case = pyRedLUM(
        res_folder=f"{working_dir}",
