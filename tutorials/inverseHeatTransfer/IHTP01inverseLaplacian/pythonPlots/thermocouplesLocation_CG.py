...
relError_L2norm = np.load("../caseDir/ITHACAoutput/thermocouplesLocationTest_CG/relError_L2norm_mat.npy")
relError_LinfNorm = np.load("../caseDir/ITHACAoutput/thermocouplesLocationTest_CG/relError_LinfNorm_mat.npy")
TCplane_Y = np.load("../caseDir/ITHACAoutput/thermocouplesLocationTest_CG/TCplane_Y_mat.npy")
